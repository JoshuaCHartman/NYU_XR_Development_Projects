...
## Week 5 - C# Scripting 
- 3D Platformer - scripts to control platform movement (editable in the Inspector), and collectibles rotation. Creation of custom materials with automatic opacity shifting defined by script, and editable in the Inspector. Instantiation of prefabs after collectibles gathered. Creation of additional playable area using a variety of rigidbody physics and joints, a scripted teleport system, scripted TextMeshPro controls, etc. 
